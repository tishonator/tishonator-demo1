...
jQuery( document ).ready(function() {
  ...
  jQuery('#tp-main-menu-content > div > ul').unwrap();

  jQuery('#tp-main-menu-content li').each(function(){
    if (jQuery(this).find('> ul').length > 0) {
      jQuery(this).addClass('has-dropdown');
    }
  });

  jQuery('#tp-main-menu-content li ul').addClass('tp-submenu submenu has-homemenu');


  if(jQuery('.tp-main-menu-content').length && jQuery('.tp-main-menu-mobile').length){
    let navContent = document.querySelector(".tp-main-menu-content").outerHTML;
    let mobileNavContainer = document.querySelector(".tp-main-menu-mobile");
    mobileNavContainer.innerHTML = navContent;
  
  
    let arrow = jQuery(".tp-main-menu-mobile .has-dropdown > a");
...
//t assets/js/imagesloaded-pkgd.js
