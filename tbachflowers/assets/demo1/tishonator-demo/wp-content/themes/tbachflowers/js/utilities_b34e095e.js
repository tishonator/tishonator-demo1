...
function tishonator_init_loading_effects() {
  ...
  if (tishonator_options.animations_hdr_img_ttl && tishonator_options.animations_hdr_img_ttl != 'none') {

    jQuery('#hdr-img-content h1').addClass("animations-hidden").viewportChecker({
      repeat: tishonator_options.animations_repeat,
      classToAdd: 'animated ' + tishonator_options.animations_hdr_img_ttl,
      offset: 1
    });
  }

  if (tishonator_options.animations_hdr_img_txt && tishonator_options.animations_hdr_img_txt != 'none') {

    jQuery('#hdr-img-content p').addClass("animations-hidden").viewportChecker({
      repeat: tishonator_options.animations_repeat,
      classToAdd: 'animated ' + tishonator_options.animations_hdr_img_txt,
      offset: 1
    });
  }

  if (tishonator_options.animations_hdr_img_btn && tishonator_options.animations_hdr_img_btn != 'none') {

    jQuery('#hdr-img-content a.hdr-read-more').addClass("animations-hidden").viewportChecker({
      repeat: tishonator_options.animations_repeat,
      classToAdd: 'animated ' + tishonator_options.animations_hdr_img_btn,
      offset: 1
    });
  }
  ...
  if (tishonator_options.animations_page_hdr && tishonator_options.animations_page_hdr != 'none') {
    ...
    jQuery('#page-header, article h1, h1.entry-title').addClass("animations-hidden").viewportChecker({
      repeat: tishonator_options.animations_repeat,
