    ...
    jQuery.extend(!0, _R, {
        ...
        callingNewSlide: function(e, i) {
            var t = 0 < e.find(".next-revslide").length ? e.find(".next-revslide").index() : 0 < e.find(".processing-revslide").length ? e.find(".processing-revslide").index() : e.find(".active-revslide").index(),
                a = 0,
                n = e[0].opt;
            e.find(".next-revslide").removeClass("next-revslide"), e.find(".active-revslide").hasClass("tp-invisible-slide") && (t = n.last_shown_slide), i && (!isNaN(parseFloat(i)) && isFinite(i)) || i.match(/to/g) ? (a = 1 === i || -1 === i ? (a = t + i) < 0 ? n.slideamount - 1 : a >= n.slideamount ? 0 : a : (i = (!isNaN(parseFloat(i)) && isFinite(i)) ? i : parseInt(i.split("to")[1], 0)) < 0 ? 0 : i > n.slideamount - 1 ? n.slideamount - 1 : i, e.find(".tp-revslider-slidesli").eq(a).addClass("next-revslide")) : i && e.find(".tp-revslider-slidesli").each(function() {
                var e = jQuery(this);
    ...
    var _ISM = _R.is_mobile(),
        ...
        runSlider = function(t, x) {
            ...
            if (x.shadow !== undefined && 0 < x.shadow && (t.parent().addClass("tp-shadow" + x.shadow), t.parent().append('<div class="tp-shadowcover"></div>'), t.parent().find(".tp-shadowcover").css({
                ...
                var g = x.viewPort;
                x.inviewport = !1, g != undefined && g.enable && ((!isNaN(parseFloat(g.visible_area)) && isFinite(g.visible_area)) || -1 !== g.visible_area.indexOf("%") && (g.visible_area = parseInt(g.visible_area) / 100), _R.scrollTicker && _R.scrollTicker(x, t)), "carousel" === x.sliderType && _R.prepareCarousel && (punchgs.TweenLite.set(x.ul, {
                    opacity: 0
                ...
                if (e.data("loaded") === undefined && t !== undefined && t.progress && t.progress.match(/loaded/g)) {
                    if (e.attr("src", t.src), "img" == t.type)
                        if (e.hasClass("defaultimg")) _R.isIE(8) ? defimg.attr("src", t.src) : -1 == t.src.indexOf("images/transparent.png") && -1 == t.src.indexOf("assets/transparent.png") || e.data("bgcolor") === undefined ? e.css({
                            ...
                            var a = e.data("ww"),
                                n = e.data("hh");
                            e.data("owidth", t.width), e.data("oheight", t.height), a = a == undefined || "auto" == a || "" == a ? t.width : a, n = n == undefined || "auto" == n || "" == n ? t.height : n, !(!isNaN(parseFloat(a)) && isFinite(a)) && 0 < a.indexOf("%") && (n = a), e.data("ww", a), e.data("hh", n)
                        }
...
! function(e) {
    ...
    function j(e) {
        return null == e ? -1 : (!isNaN(parseFloat(e)) && isFinite(e)) ? e : 1 < e.split(":").length ? 60 * parseInt(e.split(":")[0], 0) + parseInt(e.split(":")[1], 0) : e
    }
    jQuery.extend(!0, I, {
...
! function(t) {
    ...
    var ut = function(t, e) {
            return null == e || (!isNaN(parseFloat(t)) && isFinite(t)) ? t : null == t ? t : t.split(",")[e]
        },
                ...
                case "jumptoslide":
                    switch (a.slide.toLowerCase()) {
                        ...
                        case "-1":
                            ...
                            break;
                        default:
                            var ts = (!isNaN(parseFloat(a.slide)) && isFinite(a.slide)) ? parseInt(a.slide, 0) : a.slide;
...
! function(e) {
    ...
    jQuery.extend(!0, A, {
        updateMarkup: function(e, t) {
            ...
            if (void 0 !== i.start && !i.frames_added && void 0 === i.frames) {
                ...
                (!isNaN(parseFloat(i.end)) && isFinite(i.end)) && (!isNaN(parseFloat(i.start)) && isFinite(i.start)) && (!isNaN(parseFloat(n.speed)) && isFinite(n.speed)) && (i.end = parseInt(i.end, 0) - (parseInt(i.start, 0) + parseFloat(n.speed, 0))), a.push({
                    frame: "0",
                    delay: i.start,
                    from: i.transform_in,
                    to: i.transform_idle,
        ...
        prepareSingleCaption: function(e) {
            ...
            if ("off" === (void 0 === i.visibility ? "oon" : N(i.visibility, a)[a.forcedWinRange] || N(i.visibility, a) || "ooon") || i._gw < a.hideCaptionAtLimit && "on" == i.captionhidden || i._gw < a.hideAllCaptionAtLimit ? i._pw.addClass("tp-hidden-caption") : i._pw.removeClass("tp-hidden-caption"), i.layertype = "html", e.offsetx < 0 && (e.offsetx = 0), null != i.thumbimage && null == i.videoposter && (i.videoposter = i.thumbimage), 0 < t.find("img").length) {
                ...
                } else l = g ? c : !(!isNaN(parseFloat(l)) && isFinite(l)) && 0 < l.indexOf("%") ? l : parseFloat(l), m = u ? p : !(!isNaN(parseFloat(m)) && isFinite(m)) && 0 < m.indexOf("%") ? m : parseFloat(m);
                l = void 0 === l ? 0 : l, m = void 0 === m ? 0 : m, "off" !== i._responsive ? ("grid" != i._ba && g ? (!isNaN(parseFloat(l)) && isFinite(l)) ? d.css({
                    width: l + "px"
                }) : d.css({
                    width: l
                }) : (!isNaN(parseFloat(l)) && isFinite(l)) ? d.css({
                    width: l * a.bw + "px"
                }) : d.css({
                    width: l
                }), "grid" != i._ba && u ? (!isNaN(parseFloat(m)) && isFinite(m)) ? d.css({
                    height: m + "px"
                }) : d.css({
                    height: m
                }) : (!isNaN(parseFloat(m)) && isFinite(m)) ? d.css({
                    height: m * a.bh + "px"
                }) : d.css({
                    height: m
                })) : d.css({
                    width: l,
                    height: m
                }), i._ingroup && "row" !== i._nctype && (void 0 !== l && !(!isNaN(parseFloat(l)) && isFinite(l)) && "string" === typeof l && 0 < l.indexOf("%") && punchgs.TweenLite.set([i._lw, i._pw, i._mw], {
                    minWidth: l
                }), void 0 !== m && !(!isNaN(parseFloat(m)) && isFinite(m)) && "string" === typeof m && 0 < m.indexOf("%") && punchgs.TweenLite.set([i._lw, i._pw, i._mw], {
                    minHeight: m
                }))
            }
            ...
            if (t.hasClass("tp-videolayer") || t.hasClass("tp-audiolayer") || 0 < t.find("iframe").length || 0 < t.find(v).length) {
                ...
                l = "auto" === l || !(!isNaN(parseFloat(l)) && isFinite(l)) && 0 < l.indexOf("%") ? "auto" === l ? "auto" : "grid" === i._ba ? a.gridwidth[a.curWinRange] * a.bw : i._gw : parseFloat(l) * a.bw + "px", m = "auto" === m || !(!isNaN(parseFloat(m)) && isFinite(m)) && 0 < m.indexOf("%") ? "auto" === m ? "auto" : "grid" === i._ba ? a.gridheight[a.curWinRange] * a.bw : i._gh : parseFloat(m) * a.bh + "px", i.cssobj = void 0 === i.cssobj ? V(t, 0) : i.cssobj;
                var w = Z(i.cssobj, a);
                ...
                (0 == b && !y || 1 != i.forcecover && !t.hasClass("fullscreenvideo") && !y) && (d.width(l), d.height(m)), i._ingroup && null !== i.videowidth && void 0 !== i.videowidth && !(!isNaN(parseFloat(i.videowidth)) && isFinite(i.videowidth)) && 0 < i.videowidth.indexOf("%") && punchgs.TweenLite.set([i._lw, i._pw, i._mw], {
            ...
            i._ingroup && "row" !== i._nctype && (void 0 !== i._groupw && !(!isNaN(parseFloat(i._groupw)) && isFinite(i._groupw)) && 0 < i._groupw.indexOf("%") && punchgs.TweenLite.set([i._lw, i._pw, i._mw], {
                minWidth: i._groupw
            }), void 0 !== i._grouph && !(!isNaN(parseFloat(i._grouph)) && isFinite(i._grouph)) && 0 < i._grouph.indexOf("%") && punchgs.TweenLite.set([i._lw, i._pw, i._mw], {
                minHeight: i._grouph
            }))
        },
        ...
        .on('mouseleave', function(e) {
                ...
                for (var l = 0; l < n.frames.length; l++)
                    if (l !== n.hoverframeindex) {
                        ...
                        void 0 !== t.firstslide && "frame_0" === m && (i.addLabel("slide_" + t.firstslide + "_pause", 0), i.addPause("slide_" + t.firstslide + "_pause"), i.addLabel("slide_" + t.firstslide, "+=0.005")), void 0 !== t.lastslide && "frame_999" === m && (i.addLabel("slide_" + t.lastslide + "_pause", "+=0.01"), i.addPause("slide_" + t.lastslide + "_pause"), i.addLabel("slide_" + t.lastslide, "+=0.005")), (!isNaN(parseFloat(p)) && isFinite(p)) ? i.addLabel(m, "+=" + p) : (i.addLabel("pause_" + l, "+=0.01"), i.addPause("pause_" + l), i.addLabel(m, "+=0.01")), i = A.createFrameOnTimeline({
                            caption: e.caption,
                            timeline: i,
                            label: m,
                            frameindex: l,
    ...
    var O = function(e, t, i, a, n, r, o, s, d) {
        ...
        Y = function(e, t, i, a, n, r, o) {
            return !(!isNaN(parseFloat(e)) && isFinite(e)) && e.match(/%]/g) ? (e = e.split("[")[1].split("]")[0], "horizontal" == o ? e = (i + 2) * parseInt(e, 0) / 100 : "vertical" == o && (e = (a + 2) * parseInt(e, 0) / 100)) : e = "top" === (e = "left" === (e = "layer_top" === (e = "layer_left" === e ? 0 - i : "layer_right" === e ? i : e) ? 0 - a : "layer_bottom" === e ? a : e) || "stage_left" === e ? 0 - i - r : "right" === e || "stage_right" === e ? t.conw - r : "center" === e || "stage_center" === e ? t.conw / 2 - i / 2 - r : e) || "stage_top" === e ? 0 - a - n : "bottom" === e || "stage_bottom" === e ? t.conh - n : "middle" === e || "stage_middle" === e ? t.conh / 2 - a / 2 - n : e, e
        },
    ...
    var v = function(a, e) {
        ...
        _ = function(e, t, i, a) {
            return e = "full" === (e = (!isNaN(parseFloat(e)) && isFinite(e)) ? e * t + "px" : e) ? a : "auto" === e || "none" === e ? i : e
        },
        E = function(e, t, i, a) {
            var n = e.data();
            n = void 0 === n ? {} : n;
    ...
    jQuery.extend(!0, b, {
        ...
        scrollHandling: function(a, d, f) {
            ...
            if (a.scrollproc = j, b.callBackHandling && b.callBackHandling(a, "parallax", "start"), h.enable) {
                var k = 1 - Math.abs(j);
                k = k < 0 ? 0 : k, (!isNaN(parseFloat(h.visible_area)) && isFinite(h.visible_area)) || -1 !== h.visible_area.indexOf("%") && (h.visible_area = parseInt(h.visible_area) / 100), 1 - h.visible_area <= k ? a.inviewport || (a.inviewport = !0, b.enterInViewPort(a)) : a.inviewport && (a.inviewport = !1, b.leaveViewPort(a))
            }
