...
//t assets/js/modernizr.custom.js
...
//t assets/js/jquery-plugin-collection.js
/**
 * <========= Table of Contents: =========>
 *
...
(function ($) {
    ...
    $('#navbar > div > ul').unwrap();

    $('#navbar > ul').addClass('nav navbar-nav mb-2 mb-lg-0');
