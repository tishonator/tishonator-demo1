...
function tishonator_init_loading_effects() {
  ...
  if (tishonator_options.animations_email_phone && tishonator_options.animations_email_phone != 'none') {
    ...
    jQuery('#header-phone, #header-email').addClass("animations-hidden").viewportChecker({
...
(function ($) {
  ...
  $(window).on('load', function () {
    ...
    $('.partners-container').isotope({
      itemSelector: '.partner-item'
    });

    $('.courses-container').isotope({
