...
jQuery( document ).ready(function() {
  ...
  // Apply classes to the main ul
    jQuery('#navbarSupportedContent > ul').addClass('navbar-nav');

    // Apply classes to li
    jQuery('#navbarSupportedContent > ul > li').addClass('nav-item');

    // Apply classes to a
    jQuery('#navbarSupportedContent > ul > li a').addClass('nav-link');

    jQuery('#navbarSupportedContent li').each(function(){
    if (jQuery(this).find('> ul').length > 0) {
        jQuery(this).addClass('nav-space nav-item dropdown');
        jQuery(this).find('> a').addClass('dropdown-toggle dropdown-color navbar-text-color').attr('role', 'button')
          .attr('data-toggle', 'dropdown').attr('aria-haspopup', 'true').attr('aria-expanded', 'false');
        jQuery(this).find('> ul').addClass('list-unstyled drop-down-pages');
        jQuery(this).find('> ul').find('a').addClass('dropdown-item');
        jQuery(this).find('> ul').wrap('<div class="dropdown-menu drop-down-content"></div>');
    }
  });
    ...
    // Find dropdowns and apply classes
    jQuery('#navbarSupportedContent .menu-item-has-children').addClass('nav-space nav-item dropdown');
    jQuery('#navbarSupportedContent .menu-item-has-children > a').addClass('nav-link dropdown-toggle dropdown-color navbar-text-color').attr({
        'data-toggle': 'dropdown',
        'aria-haspopup': 'true',
        'aria-expanded': 'false'
    });
    jQuery('#navbarSupportedContent .menu-item-has-children > .sub-menu').addClass('dropdown-menu drop-down-content');

    // Apply classes to dropdown li and a
    jQuery('#navbarSupportedContent .menu-item-has-children .sub-menu li').addClass('nav-item');
    jQuery('#navbarSupportedContent .menu-item-has-children .sub-menu a').addClass('dropdown-item nav-link');
...
//t assets/js/custom-carousel.js
jQuery(document).ready(function() {
...
jQuery(document).ready(function() {
    var owl = jQuery('.blog-section .owl-carousel');
    owl.owlCarousel({
        margin: 30,
        nav: false,
        loop: true,
...
jQuery(document).ready(function() {
    var owl = jQuery('.servicepage-section .owl-carousel');
    owl.owlCarousel({
        margin: 30,
        nav: false,
        loop: true,
...
//t assets/js/animation_links.js
