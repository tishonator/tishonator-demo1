...
jQuery( document ).ready(function() {
  ...
  jQuery(".animsition").animsition({
   ...
   jQuery('.sub-menu-item-toggle').on('click', function(e) {
      ...
      if (subMenu.css('right') == '-99999px') {
		...
		//t jQuery('#header-main-fixed .search-form-icon').appendTo(jQuery('#header-main-fixed'));
		//t jQuery('#header-main-fixed #search-popup-content').appendTo(jQuery('#header-main-fixed'));
  ...
  if (tishonator_tishoIsLargeResolution()) {
    ...
    jQuery('#header-spacer').css('display', 'none');
  }
