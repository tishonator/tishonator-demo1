...
jQuery( document ).ready(function() {
  ...
  jQuery('#navbarNavAltMarkup > div > ul').unwrap();

  jQuery('#navbarNavAltMarkup > ul:first-child').addClass('navbar-nav m-auto');

  jQuery('#navbarNavAltMarkup > ul:first-child > li').addClass('nav-item');

  jQuery('#navbarNavAltMarkup > ul:first-child > li > a').addClass('nav-link').each(function(){
    if (jQuery(this).parent().find('> ul').length) {
      jQuery(this).append('<i class="fa fa-angle-down"></i>');
    }
  });

  jQuery('#navbarNavAltMarkup > ul:first-child ul').addClass('tf__droap_menu');

  jQuery('.loader-container').addClass('loaded');

  if (jQuery(window).width() <= 991) {
        // Hide all sub-menus initially
        jQuery('#navbarNavAltMarkup ul.menu .sub-menu').hide();

        // On click of fa-angle-down icon
        jQuery('#navbarNavAltMarkup ul.menu .fa-angle-down').on('click', function() {
...
//t js/jquery.nice-select.min.js
...
(function ($) {
  ...
  $.expr.pseudos[KEY] = function (element) {
  ...
  function Sticker(element, optionList) {
    ...
    this.defaultZIndex = this.element.css('z-index') || 90;
    ...
    if (this.options) {
      if (!activeKey) {
        ...
        if (options.scope == this.options.scope) {
          ...
          this.reset();
          setTimeout(this.locate.on(this));
        }
      }
    }
