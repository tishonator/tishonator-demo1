...
function initHeaderIconsEvents() {
	...
	jQuery('#search-popup-content').on('mouseleave', function(){
...
function initMiniCartEvents() {
  ...
  jQuery('#header-main-fixed a.cart-contents').on('mouseenter', function(){
    
    // display mini-cart if it's not visible
    if ( jQuery('#header-main-fixed #cart-popup-content').css('z-index') == '-1' ) {
    
      var rightPos = (jQuery(window).width() - (jQuery(this).offset().left + jQuery(this).outerWidth()));
      var topPos = jQuery(this).offset().top + 24;
    
      jQuery('#header-main-fixed #cart-popup-content').css('right', rightPos).css('top', topPos).css('z-index', '5000').css('opacity', '1');
    }
  });
  
  jQuery('#header-main-fixed #cart-popup-content').on('mouseleave', function(){
  
    jQuery('#header-main-fixed #cart-popup-content').css('z-index', '-1').css('opacity', '0');
  });
}
