...
/*t
  jQuery('#mobile-menu > div > ul').unwrap();

  jQuery('#mobile-menu > ul li:has(ul)').addClass('has-sub');

  jQuery('#mobile-menu ul ul').removeClass('sub-menu');
...
// meanmenu
  ...
  jQuery('.info-bar').on('click', function () {
    jQuery('.extra-info').addClass('info-open');
  });
...
//t js/imagesloaded.min.js

//t js/parallax.min.js
! function (t, i, e) {
    "use strict";
...
$('#mobile-menu > div > ul').unwrap();
  ...
  $('#mobile-menu > ul li:has(ul)').addClass('has-sub');

  $('#mobile-menu ul ul').removeClass('sub-menu');
