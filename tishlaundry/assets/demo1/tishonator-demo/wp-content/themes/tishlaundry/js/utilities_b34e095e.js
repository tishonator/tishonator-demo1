...
jQuery(document).ready(function () {
      ...
      jQuery(".faq__area-collapse-item-card-header").on('click', function () {
        if (jQuery(this).next(".faq__area-collapse-item-card-header-content").hasClass("active")) {
          jQuery(this).next(".faq__area-collapse-item-card-header-content").removeClass("active").slideUp()
          jQuery(this).children("i").removeClass("fa fa-minus").addClass("fa fa-plus")
        } else {
          jQuery(".faq__area-collapse-item-card .faq__area-collapse-item-card-header-content").removeClass("active").slideUp()
          jQuery(".faq__area-collapse-item-card .faq__area-collapse-item-card-header i").removeClass("fa fa-minus").addClass("fa fa-plus");
          jQuery(this).next(".faq__area-collapse-item-card-header-content").addClass("active").slideDown()
          jQuery(this).children("i").removeClass("fa fa-plus").addClass("fa fa-minus")
        }
      });
