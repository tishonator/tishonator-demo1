...
;(function(factory) {
    ...
    Slick.prototype.registerBreakpoints = function() {
        ...
        if ( responsiveSettings && typeof responsiveSettings === 'object' && responsiveSettings.length ) {
...
jQuery('document').ready(function () {
    ...
    jQuery('.hero-slider-7').slick({
        ...
        slidesToScroll: 1,
        autoplay: true,
        prevArrow:'<span class="arrow-prv"><i class="fa fa-angle-left" aria-hidden="true"></i></span>',
